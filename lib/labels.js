...
const INDUSTRY_LABELS = {
  ...
  mold: '模具 / Mold & Die',
  machinery: '通用机械 / General Machinery',
  medical: '医疗器械 / Medical Devices',
  rail: '高铁 / High-Speed Rail',
  other: '其他 / Other',
};
...
const PRODUCT_LABELS = {
  ...
  'grinding-circle': '砂圈',
  'diamond-points': '电镀金刚石什锦磨头',
  'diamond-wheel': '金刚石研磨轮',
  'polishing-wheel': '抛光轮',
  'active-shank': '活动带柄抛光轮',
  cowhide: '牛皮轮',
  'sponge-wheel': '海绵轮',
  'wool-wheel': '羊毛轮',
  'fiber-oil-stone': '纤维油石',
  'brush-series': '碗型/笔型系列刷',
  'latex-wheel': '橡胶轮',
  'psa-disc': '不干胶磨片',
  'polishing-series': '涂附抛光类产品',
  'rubber-point': '橡胶磨头',
  'oil-stone': '油石',
  'abrasive-stick': '砂条',
  custom: '定制 / OEM',
